...
| [`into matrix`](/commands/docs/into_matrix.md)             | Convert a nushell table or list of lists into a matrix.            | built-in |
| [`into record`](/commands/docs/into_record.md)             | Convert value to a record.                                         | built-in |
| [`into semver`](/commands/docs/into_semver.md)             | Convert a value (string, record, or semver) to a semantic version. | built-in |
