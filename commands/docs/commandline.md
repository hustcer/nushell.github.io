...
| [`commandline set-prompt`](/commands/docs/commandline_set-prompt.md) | Replace the current prompt and repaint it in place, without disturbing the line being edited. | built-in |