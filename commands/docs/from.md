...
| [`from kdl`](/commands/docs/from_kdl.md)           | Convert KDL text into structured data.                                                                                     | built-in |
| [`from md`](/commands/docs/from_md.md)             | Convert markdown text into human-friendly structured rows. Use --verbose for the full AST.                                 | built-in |
