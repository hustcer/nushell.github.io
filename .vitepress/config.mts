...
export default defineConfig({
  ...
  rewrites: {
    ...
    'book/README.md': 'book/index.md',
    'commands/README.md': 'commands/index.md',
    'cookbook/README.md': 'cookbook/index.md',
    'contributor-book/README.md': 'contributor-book/index.md',
    'lang-guide/README.md': 'lang-guide/index.md',
    'de/README.md': 'de/index.md',
    'de/book/README.md': 'de/book/index.md',
    'es/README.md': 'es/index.md',
    'es/book/README.md': 'es/book/index.md',
    'fr/README.md': 'fr/index.md',
    'fr/book/README.md': 'fr/book/index.md',
    'ja/README.md': 'ja/index.md',
    'ja/book/README.md': 'ja/book/index.md',
    'ko/README.md': 'ko/index.md',
    'ko/book/README.md': 'ko/book/index.md',
    'pt-BR/README.md': 'pt-BR/index.md',
    'pt-BR/book/README.md': 'pt-BR/book/index.md',
    'ru/README.md': 'ru/index.md',
    'ru/book/README.md': 'ru/book/index.md',
    'tr/README.md': 'tr/index.md',
    'tr/book/README.md': 'tr/book/index.md',
    'zh-CN/README.md': 'zh-CN/index.md',
    'zh-CN/book/README.md': 'zh-CN/book/index.md',
    'zh-CN/cookbook/README.md': 'zh-CN/cookbook/index.md',
    'zh-CN/contributor-book/README.md': 'zh-CN/contributor-book/index.md',
  },
